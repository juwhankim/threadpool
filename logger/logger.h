...
// logging functions.
extern void clog_f(default_log_format& log_line, const string& file_name, const string& line_number, const string& message);
extern void log_f(default_log_format& log_line, const string& file_name, const string& line_number, const string& message);
