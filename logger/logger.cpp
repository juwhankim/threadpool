...
// Start formatting.
, default_time_format
, head_element{"INFO", ANSI_foreground_color::green, delimit{"<",">"}, ANSI_text_attribute::bold}
, default_file_format
, default_line_format
...
// Start formatting.
, default_time_format
, head_element{"DEBUG", ANSI_foreground_color::yellow, delimit{"<",">"}, ANSI_text_attribute::bold}
, default_file_format
, default_line_format
, default_thread_format
, default_message_format
...
// Start formatting.
, default_time_format
, head_element{"WARNING", ANSI_foreground_color::magenta, delimit{"<",">"}, ANSI_text_attribute::bold, ANSI_text_attribute::blink}
, default_file_format
, default_line_format
, default_thread_format
, default_message_format
...
// Start formatting.
, default_time_format
, head_element{"FATAL", ANSI_foreground_color::red, delimit{"<",">"}, ANSI_text_attribute::bold, ANSI_text_attribute::blink}
, default_file_format
, default_line_format
, default_thread_format
, default_message_format
...
void clog_f(default_log_format& log_line, const string& file_name, const string& line_number, const string& message)
{
	// Guard against racing.
	std::lock_guard<std::mutex> lock(log_mutex);
	if(log_line.priority>=log_level) cout << log_line(file_string{file_name}, line_string{line_number}, message_string{message}) << endl;
}
...
void log_f(default_log_format& log_line, const string& file_name, const string& line_number, const string& message)
{
	// Guard against racing.
	std::lock_guard<std::mutex> lock(log_mutex);
	if(log_line.priority>=log_level)
	{
		if(user_log_file)
		{
			user_log_file << log_line(file_string{file_name}, line_string{line_number}, message_string{message}) << endl;
		} else if (default_log_file)
		{ 
			default_log_file << log_line(file_string{file_name}, line_string{line_number}, message_string{message}) << endl;
		} else {
