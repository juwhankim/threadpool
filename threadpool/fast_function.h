...
namespace juwhan {
    namespace internal {
        ...
        struct simplify_member_function<size_of_a_ptr_to_void_void_member_func> {
            template<class TThis, class TFunc>
            inline static ptr_to_any_class
            convert(const TThis *mThis, TFunc mFunc, ptr_to_void_void_member_func &mFuncOut) noexcept {
        ...
        public:
            ...
            inline void bind(TThis *mThis, TInvoker mInvoker, ptr_to_static_func mFunc) noexcept {
            ...
            inline bool operator==(ptr_to_static_func mPtr) const noexcept {
                return mPtr == nullptr ? *this == nullptr : mPtr ==
                                                            reinterpret_cast<ptr_to_static_func>(get_static_func_ptr());
            }
            ...
            inline ::std::size_t getHash() const noexcept {
                return reinterpret_cast<::std::size_t>(this_ptr) ^
                       internal::unsafe_horrible_cast<::std::size_t>(func_ptr);
            }

            inline ptr_to_any_class get_this_ptr() const noexcept { return this_ptr; }

            inline ptr_to_member_func
            get_member_func_ptr() const noexcept { return reinterpret_cast<ptr_to_member_func>(func_ptr); }

            inline ptr_to_static_func get_static_func_ptr() const noexcept {
                return horrible_cast<ptr_to_static_func>(this);
            }
        };
        ...
        public:
            ...
            inline fast_function_implementation(X *mThis, Y mFunc) noexcept { bind(mThis, mFunc); }
            ...
            inline bool operator==(const fast_function_implementation &mImpl) const noexcept {
