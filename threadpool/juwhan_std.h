...
template<>
struct is_integral_helper<float> : true_type {
};
template<>
struct is_integral_helper<double> : true_type {
};
template<typename T>
...
F_T_H_MACRO(1); F_T_H_MACRO(2); F_T_H_MACRO(3); F_T_H_MACRO(4); F_T_H_MACRO(5); F_T_H_MACRO(6); F_T_H_MACRO(
        7); F_T_H_MACRO(8); F_T_H_MACRO(9); F_T_H_MACRO(10);
#undef F_T_H_MACRO
...
public:
    ...
    noexcept : _ptr(::std::addressof(ref)) {};
...
template<class T>
inline typename add_rvalue_reference<T>::type declval()
...
template<typename T>
struct result_of : detail::result_of<T> {
};

template<typename R = void, typename... A>
struct function_type_deduction {
};

template<typename R, typename... A>
struct function_type_deduction<R(A...)> {
...
template<typename R, typename C, typename... A>
struct function_type_deduction<R(C::*)(A...)> {
...
template<typename R, typename C, typename... A>
struct function_type_deduction<R(C::*)(A...) const> {
    static constexpr bool is_static = false;
    static constexpr bool is_member = true;
    static constexpr bool is_functor = false;
...
template<typename T>
struct function_type_deduction<T> : function_type_deduction<decltype(&T::operator())> {
    static constexpr bool is_static = false;
    static constexpr bool is_member = false;
